                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center space-x-4 text-apple-caption1 text-apple-gray-400">
                      <div className="flex items-center">
                        <kbd className="px-2 py-1 bg-apple-gray-100 dark:bg-apple-gray-800 rounded text-xs">⌘</kbd>
                        <span className="ml-1">+</span>
                        <kbd className="px-2 py-1 bg-apple-gray-100 dark:bg-apple-gray-800 rounded text-xs ml-1">N</kbd>
                      </div>
                      <span>快速创建</span>
                    </div>
                  </div>
